...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("ధన్యవాదాలు! మీ సందేశం అందింది. మేము త్వరలోనే సంప్రదిస్తాము.");
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="rounded-xl bg-white/5 ring-1 ring-white/10 p-8">
            <h2 className="text-3xl font-bold text-[var(--foreground)] mb-6">
              మమ్మల్ని సంప్రదించండి
            </h2>
            <p className="text-[var(--foreground)]/70 mb-8">
              మీ ప్రశ్నలు, సూచనలు లేదా ఫీడ్‌బ్యాక్‌ను మాకు పంపండి. మేము త్వరలోనే
              స్పందిస్తాము.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg bg-white/5 ring-1 ring-white/10 text-[var(--foreground)] placeholder:text-[var(--foreground)]/40 focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-lg bg-white/5 ring-1 ring-white/10 text-[var(--foreground)] placeholder:text-[var(--foreground)]/40 focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
                  placeholder="సందేశం విషయం నమోదు చేయండి"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 rounded-lg bg-white/5 ring-1 ring-white/10 text-[var(--foreground)] placeholder:text-[var(--foreground)]/40 focus:outline-none focus:ring-2 focus:ring-[var(--primary)] transition-colors resize-none"
                  placeholder="మీ సందేశాన్ని ఇక్కడ వ్రాయండి..."
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[var(--primary)] text-white py-3 px-6 rounded-lg font-semibold hover:opacity-90 transition-colors duration-300 focus:ring-2 focus:ring-[var(--primary)]"
              >
                సందేశం పంపండి
              </button>
            </form>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--foreground)]/70">
                      info@andhrainsight.com
                      <br />
                      support@andhrainsight.com
                    </p>
                  </div>
                </div>
            ...
            <div className="rounded-xl bg-white/5 ring-1 ring-white/10 p-8">
              ...
              <p className="text-[var(--foreground)]/70 mb-6">
                తాజా అప్డేట్స్ కోసం మా సోషల్ మీడియాను అనుసరించండి.
              </p>
